...
class Config {
	...
	// Physics
    public static inline final GRAVITY:Float = 800;
    ...
    public static inline final START_WORLD:String = "02_00";
    public static final WORLDS:Array<String> = ["02_00", "02_01", "02_02"];
}